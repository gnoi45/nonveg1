...
class EggProducts extends StatelessWidget {
      ...
      body: FutureBuilder<List<Product>>(
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData
              ? EggProductsState(faqList: snapshot.data)
...
class EggProductsState extends StatelessWidget {
  List<Product> faqList = List<Product>();

  EggProductsState({Key key, this.faqList}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
