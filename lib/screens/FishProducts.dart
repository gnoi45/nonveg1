...
class FishProducts extends StatelessWidget {
      ...
      body: FutureBuilder<List<Product>>(
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData
              ? FishProductsState(faqList: snapshot.data)
...
class FishProductsState extends StatelessWidget {
  List<Product> faqList = List<Product>();

  FishProductsState({Key key, this.faqList}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
