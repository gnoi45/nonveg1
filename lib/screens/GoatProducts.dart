...
class GoatProducts extends StatelessWidget {
      ...
      body: FutureBuilder<List<Product>>(
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData
              ? GoatProductsState(faqList: snapshot.data)
...
class GoatProductsState extends StatelessWidget {
  List<Product> faqList = List<Product>();

  GoatProductsState({Key key, this.faqList}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
