...
class SpicesProducts extends StatelessWidget {
      ...
      body: FutureBuilder<List<Product>>(
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData
              ? ComboProductsState(faqList: snapshot.data)
...
class ComboProductsState extends StatelessWidget {
  List<Product> faqList = List<Product>();

  ComboProductsState({Key key, this.faqList}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
